...
def index_page(request):
    return render(request,template_name = "Technical_Forums/index.html")
...
def signup(request):
    ...
    return render(request,template_name="Technical_Forums/index.html",context=context_message)
...
def ask_question_page(request):
    return render(request,template_name="Technical_Forums/ask_question.html")
...
def add_new_question(request):
    ...
    new_question = Question(question_title=new_question_title,question_description=new_question_description,questioned_by=new_questioned_by)
    new_question.save()
...
def add_answer(request,pk):
    ...
    new_answer = Answer(answer_description=new_answer_description,answered_by=new_answered_by,answered_to=question_details)
    new_answer.save()
...
def post_comment_to_answer(request,pk):
    ...
    new_comment = Comment(comment_description=new_comment_description,commented_by=new_comment_by,commented_to_answer=new_comment_to)
    new_comment.save()
...
def post_comment_to_question(request,pk):
    ...
    new_comment_description = request.GET.get('comment')
    new_comment_by = request.user
    new_comment = Comment(comment_description=new_comment_description,commented_by=new_comment_by,commented_to_question=new_comment_to)
    new_comment.save()
...
def view_tags(request):
    ...
    if tag_details:
        ...
        context_message = {}
    return render(request,template_name="Technical_Forums/view_tags.html",context=context_message)
...
def update_question(request,pk):
    ...
    return render(request,template_name="Technical_Forums/update_question.html",context=context_message)

def update_answer(request,pk):
    answer_details = Answer.objects.get(id=pk)
    context_message = {"answer_details":answer_details}
    return render(request,template_name="Technical_Forums/update_answer.html",context=context_message)
